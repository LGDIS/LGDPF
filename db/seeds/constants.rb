...
# 妊娠である
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'pregnancy', text: '該当しない', value: '0', _order: '1')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'pregnancy', text: '妊娠中', value: '1', _order: '2')
# 乳幼児である
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'baby', text: '該当しない', value: '0', _order: '1')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'baby', text: '乳児', value: '1', _order: '2')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'baby', text: '幼児', value: '2', _order: '3')
# 要介護者である
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'upper_care_level_three', text: '該当しない', value: '00', _order: '1')
...
# 一人暮らし高齢者（65歳以上）である
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'elderly_alone', text: '該当しない', value: '0', _order: '1')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'elderly_alone', text: '該当する', value: '1', _order: '2')
# 高齢者世帯（夫婦共に65歳以上）である
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'elderly_couple', text: '該当しない', value: '0', _order: '1')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'elderly_couple', text: '該当する', value: '1', _order: '2')
# 寝たきり高齢者である
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'bedridden_elderly', text: '該当しない', value: '0', _order: '1')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'bedridden_elderly', text: '該当する', value: '1', _order: '2')
# 認知症高齢者である
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'elderly_dementia', text: '該当しない', value: '0', _order: '1')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'elderly_dementia', text: '該当する', value: '1', _order: '2')
# 療育手帳所持者である
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'rehabilitation_certificate', text: '所持なし', value: '99', _order: '1')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'rehabilitation_certificate', text: '最重度', value: '01', _order: '2')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'rehabilitation_certificate', text: 'OA', value: '02', _order: '3')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'rehabilitation_certificate', text: 'A1', value: '03', _order: '4')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'rehabilitation_certificate', text: '1度', value: '04', _order: '5')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'rehabilitation_certificate', text: '重度', value: '05', _order: '6')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'rehabilitation_certificate', text: 'A', value: '06', _order: '7')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'rehabilitation_certificate', text: 'A2', value: '07', _order: '8')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'rehabilitation_certificate', text: '2度', value: '08', _order: '9')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'rehabilitation_certificate', text: '中度', value: '09', _order: '10')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'rehabilitation_certificate', text: 'B', value: '10', _order: '11')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'rehabilitation_certificate', text: 'B1', value: '11', _order: '12')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'rehabilitation_certificate', text: '3度', value: '12', _order: '13')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'rehabilitation_certificate', text: '軽度', value: '13', _order: '14')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'rehabilitation_certificate', text: 'C', value: '14', _order: '15')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'rehabilitation_certificate', text: 'B2', value: '15', _order: '16')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'rehabilitation_certificate', text: '4度', value: '16', _order: '17')
# 身体障害者手帳所持者である
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'physical_disability_certificate', text: '該当しない', value: '0', _order: '1')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'physical_disability_certificate', text: '1級', value: '1', _order: '2')
Constant.create(kind1: 'TD', kind2: 'people', kind3: 'physical_disability_certificate', text: '2級', value: '2', _order: '3')
